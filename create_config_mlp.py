...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description=f'Generalized training configuration script for MLP.')
    ...
    parser.add_argument('--layers', '--hidden-layers', dest='hidden_layers', type=int, action='extend', nargs="+")
    ...
    from rbfkan_utils.models import LambdaModule, MLP
    ...
    if final_act != torch.nn.Identity:
        ...
        model_layers = OrderedDict([('mlp', mlp_layer)])
    ...
    if args.dynamic_dropout:
        ...
        dropout_lambda = (
            ...
            f"model._modules['mlp'].dropout_rate.set("
